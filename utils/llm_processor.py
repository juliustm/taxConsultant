        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "uin": {"type": "string"},
                    "total_amount": {"type": "string", "description": "The total amount. Can be a string with commas (e.g. '10,000')."},
                    "vat_amount": {"type": "string", "description": "The VAT amount. Can be a string with commas."},
